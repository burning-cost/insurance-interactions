...
[`insurance_interactions_demo.py`](https://github.com/burning-cost/burning-cost-examples/blob/main/notebooks/insurance_interactions_demo.py) — the workflow demo:
